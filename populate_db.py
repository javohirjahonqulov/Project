...
# Django settings-ni to'g'ri sozlash
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'crm_project.settings')  # crm_yusuf — loyihangiz papkasi nomi
django.setup()
...
# Telefon raqamidan +998 ni olib tashlash uchun funksiya
